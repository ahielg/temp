...
public class ActionBarImpl extends ActionBar
{
  ...
  public void hide()
  {
    ...
    while (true)
    {
      ...
      if (this.mShowHideAnimationEnabled)
      {
        ...
        ActionBarContainer localActionBarContainer1 = this.mContainerView;
        float[] arrayOfFloat1 = new float[1];
        arrayOfFloat1[0] = 0.0F;
        AnimatorSet.Builder localBuilder = localAnimatorSet.play(ObjectAnimator.ofFloat(localActionBarContainer1, "alpha", arrayOfFloat1));
        if (this.mContentView != null)
        {
          NineFrameLayout localNineFrameLayout = this.mContentView;
          float[] arrayOfFloat3 = new float[2];
          arrayOfFloat3[0] = 0.0F;
          arrayOfFloat3[1] = (-this.mContainerView.getHeight());
          localBuilder.with(ObjectAnimator.ofFloat(localNineFrameLayout, "translationY", arrayOfFloat3));
          ActionBarContainer localActionBarContainer3 = this.mContainerView;
          float[] arrayOfFloat4 = new float[1];
          arrayOfFloat4[0] = (-this.mContainerView.getHeight());
          localBuilder.with(ObjectAnimator.ofFloat(localActionBarContainer3, "translationY", arrayOfFloat4));
        }
        if ((this.mSplitView != null) && (this.mSplitView.getVisibility() == 0))
        {
          ...
          localBuilder.with(ObjectAnimator.ofFloat(localActionBarContainer2, "alpha", arrayOfFloat2));
        }
  ...
  public void removeTabAt(int paramInt)
  {
    ...
    label130: for (Object localObject = null; ; localObject = (TabImpl)this.mTabs.get(Math.max(0, paramInt - 1)))
    {
      selectTab((ActionBar.Tab)localObject);
      break;
      i = this.mSavedTabPosition;
      break label23;
      label107: ((TabImpl)this.mTabs.get(k)).setPosition(k);
      k++;
      break label65;
    }
  }
    ...
    while (true)
    {
      ...
      if (this.mShowHideAnimationEnabled)
      {
        ...
        if (this.mContentView != null)
        {
          NineFrameLayout localNineFrameLayout = this.mContentView;
          float[] arrayOfFloat3 = new float[2];
          arrayOfFloat3[0] = (-this.mContainerView.getHeight());
