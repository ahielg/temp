...
public class IcsProgressBar extends View
{
  ...
  private Drawable tileify(Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    if ((paramDrawable instanceof LayerDrawable))
    {
      ...
      arrayOfDrawable = new Drawable[i];
      j = 0;
      if (j >= i)
      {
    ...
    while (true)
    {
      ...
      label121: ((LayerDrawable)localObject1).setId(k, localLayerDrawable.getId(k));
      k++;
      break label50;
  ...
  private Drawable tileifyIndeterminate(Drawable paramDrawable)
  {
    ...
    {
      localAnimationDrawable1 = (AnimationDrawable)paramDrawable;
      i = localAnimationDrawable1.getNumberOfFrames();
      localAnimationDrawable2 = new AnimationDrawable();
  ...
  private void updateDrawableBounds(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      this.mIndeterminateDrawable.setBounds(0, 0, i - m, j - k);
      this.mIndeterminateRealLeft = m;
      this.mIndeterminateRealTop = k;
      if (this.mProgressDrawable != null)
        this.mProgressDrawable.setBounds(0, 0, i, j);
      return;
      label177: int i2 = (int)(paramInt1 * (1.0F / f1));
      k = (paramInt2 - i2) / 2;
      j = k + i2;
    }
  }
