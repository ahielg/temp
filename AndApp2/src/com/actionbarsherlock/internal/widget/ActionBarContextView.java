  ...
  implements Animator.AnimatorListener
{
  ...
  private void initTitle()
  {
    ...
    int j;
    int k;
    label167: TextView localTextView;
    ...
    label233: label238: for (int m = 0; ; m = i)
    {
  ...
  private Animator makeInAnimation()
  {
    ...
    ObjectAnimator localObjectAnimator1 = ObjectAnimator.ofFloat(localNineLinearLayout, "translationX", arrayOfFloat1);
    ...
    for (int k = 0; ; k++)
    {
      ...
      ObjectAnimator localObjectAnimator2 = ObjectAnimator.ofFloat(localAnimatorProxy, "scaleY", arrayOfFloat2);
  ...
  private Animator makeOutAnimation()
  {
    NineLinearLayout localNineLinearLayout = this.mClose;
    float[] arrayOfFloat1 = new float[1];
    arrayOfFloat1[0] = (-this.mClose.getWidth() - ((ViewGroup.MarginLayoutParams)this.mClose.getLayoutParams()).leftMargin);
    ObjectAnimator localObjectAnimator1 = ObjectAnimator.ofFloat(localNineLinearLayout, "translationX", arrayOfFloat1);
    localObjectAnimator1.setDuration(200L);
    localObjectAnimator1.addListener(this);
    localObjectAnimator1.setInterpolator(new DecelerateInterpolator());
  ...
  public void initForMode(ActionMode paramActionMode)
  {
    ...
    while (true)
    {
      ...
      addView(this.mClose);
      break;
      label191: this.mActionMenuPresenter.setWidthLimit(getContext().getResources().getDisplayMetrics().widthPixels, true);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      break;
      label418: i6 = -2147483648;
      break label299;
      label426: i7 = m;
      break label319;
      label433: i8 = -2147483648;
      break label334;
      label441: i9 = n;
      break label354;
      label448: int i5 = k + getChildAt(i4).getMeasuredHeight();
      if (i5 > i2)
        i2 = i5;
      i4++;
      break label394;
      label479: setMeasuredDimension(i, j);
    }
  }
  ...
  public void setSplitActionBar(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      return;
      label95: this.mActionMenuPresenter.setWidthLimit(getContext().getResources().getDisplayMetrics().widthPixels, true);
      this.mActionMenuPresenter.setItemLimit(2147483647);
      localLayoutParams.width = -1;
      localLayoutParams.height = this.mContentHeight;
      this.mMenuView = ((ActionMenuView)this.mActionMenuPresenter.getMenuView(this));
