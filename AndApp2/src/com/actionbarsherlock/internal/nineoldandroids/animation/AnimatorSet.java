...
public final class AnimatorSet extends Animator
{
  ...
  private void sortNodes()
  {
    if (this.mNeedsSort)
    {
      ...
      label176: Node localNode2 = (Node)localArrayList1.get(i3);
  ...
  public void cancel()
  {
    ...
    while (true)
    {
      if (!localIterator2.hasNext())
      {
        this.mStarted = false;
        return;
        label96: ((Animator.AnimatorListener)localIterator3.next()).onAnimationCancel(this);
        break;
        label115: if (this.mSortedNodes.size() <= 0)
          break label72;
  ...
  public Builder play(Animator paramAnimator)
  {
    ...
    for (Builder localBuilder = new Builder(paramAnimator); ; localBuilder = null)
      return localBuilder;
  }
  ...
  public void start()
  {
    ...
    for (int i2 = 0; ; i2++)
    {
      if (i2 >= i1)
      {
        ...
        label275: Node localNode1 = (Node)this.mSortedNodes.get(k);
        if (this.mSetListener == null)
          this.mSetListener = new AnimatorSetListener(this);
        if ((localNode1.dependencies == null) || (localNode1.dependencies.size() == 0))
        {
        ...
        label439: Node localNode2 = (Node)localIterator1.next();
        localNode2.animation.start();
        this.mPlayingSet.add(localNode2.animation);
        break label61;
        label475: float[] arrayOfFloat = new float[2];
        arrayOfFloat[0] = 0.0F;
        arrayOfFloat[1] = 1.0F;
        this.mDelayAnim = ValueAnimator.ofFloat(arrayOfFloat);
        this.mDelayAnim.setDuration(this.mStartDelay);
        this.mDelayAnim.addListener(new AnimatorListenerAdapter(localArrayList1)
        {
        ...
        break label71;
        label537: ((Animator.AnimatorListener)localArrayList3.get(i4)).onAnimationStart(this);
        i4++;
        break label100;
      }
    ...
    implements Animator.AnimatorListener
  {
    ...
    public void onAnimationEnd(Animator paramAnimator)
    {
      ...
      int i;
      int k;
      label72: ArrayList localArrayList2;
      int m;
      ...
      for (int n = 0; ; n++)
      {
        if (n >= m)
        {
          ...
          return;
          label128: if (!((AnimatorSet.Node)localArrayList1.get(k)).done)
          {
            i = 0;
            break label72;
          }
