  ...
  implements Cloneable
{
  ...
  private Method getPropertyFunction(Class paramClass1, String paramString, Class paramClass2)
  {
    ...
    Class[] arrayOfClass1 = (Class[])null;
    Object localObject2;
    if (paramClass2 == null)
      try
      {
        Method localMethod = paramClass1.getMethod(str, arrayOfClass1);
    ...
    while (true)
      while (true)
      {
        if (j >= i)
        {
          ...
          {
            arrayOfClass3 = INTEGER_VARIANTS;
            break label122;
          }
          if (this.mValueType.equals(Double.class))
          {
            arrayOfClass3 = DOUBLE_VARIANTS;
            break label122;
          }
          arrayOfClass3 = new Class[1];
          arrayOfClass3[0] = this.mValueType;
          break label122;
        }
        ...
        try
        {
          localObject1 = paramClass1.getMethod(str, arrayOfClass2);
  ...
  public static PropertyValuesHolder ofKeyframe(String paramString, Keyframe[] paramArrayOfKeyframe)
  {
    ...
    while (true)
    {
      ...
      ((PropertyValuesHolder)localObject).mValueType = paramArrayOfKeyframe[0].getType();
    }
  }
