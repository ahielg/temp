  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    int i19;
    int i20;
    label483: label871: for (int i21 = (int)(i5 * i4 / f); ; i21 = 0)
    {
      i22 = 0;
      if (i22 < i11)
        break label877;
    ...
    label594: label601: label607: label865: label877: if ((l1 & 1 << i22) == 0L);
    while (true)
    {
      i22++;
      break;
    ...
    label1040: View localView2 = getChildAt(i20);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    while (true)
    {
      ...
      label398: i9 = 0;
      break label326;
      label404: int i13 = i11 + localLayoutParams2.leftMargin;
