  ...
  implements com.actionbarsherlock.view.Menu
{
  ...
  public boolean bindNativeOverflow(android.view.Menu paramMenu, MenuItem.OnMenuItemClickListener paramOnMenuItemClickListener, HashMap<android.view.MenuItem, MenuItemImpl> paramHashMap)
  {
    ...
    while (localIterator1.hasNext())
    {
      ...
      label130: if (localIterator2.hasNext())
        break label295;
    }
    label295: label483: for (android.view.MenuItem localMenuItem1 = localSubMenu.getItem(); ; localMenuItem1 = paramMenu.add(localMenuItemImpl1.getGroupId(), localMenuItemImpl1.getItemId(), localMenuItemImpl1.getOrder(), localMenuItemImpl1.getTitle()))
    {
  ...
  public boolean collapseItemActionView(MenuItemImpl paramMenuItemImpl)
  {
    ...
    stopDispatchingItemsChanged();
    Iterator localIterator = this.mPresenters.iterator();
    label36: if (!localIterator.hasNext());
    while (true)
    {
      startDispatchingItemsChanged();
      if (!bool)
  ...
  public void flagActionItems()
  {
    ...
    while (true)
    {
      ...
      break label18;
      label125: MenuItemImpl localMenuItemImpl = (MenuItemImpl)localArrayList.get(j);
      ...
      label174: this.mActionItems.clear();
      this.mNonActionItems.clear();
