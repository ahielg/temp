  ...
  implements ActivityChooserModel.ActivityChooserModelClient
{
  ...
  private final ViewTreeObserver.OnGlobalLayoutListener mOnGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener()
  {
    public void onGlobalLayout()
    {
      ...
      {
        return;
        label31: ActivityChooserView.this.getListPopupWindow().show();
  ...
  private void updateAppearance()
  {
    if (this.mAdapter.getCount() > 0)
    {
      ...
      label139: if (this.mDefaultActivityButton.getVisibility() != 0)
        break label184;
    ...
    while (true)
    {
      ...
      break;
      label172: this.mDefaultActivityButton.setVisibility(8);
      break label139;
      label184: this.mActivityChooserContent.setBackgroundDrawable(null);
    }
  }
  ...
  private class ActivityChooserViewAdapter extends BaseAdapter
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      while (true)
      {
        localView = paramView;
        break;
        label238: ActivityChooserView.SetActivated.invoke(paramView, false);
      }
    }
