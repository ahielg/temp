  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      if (!this.mIsBeingDragged)
      {
        ...
        float f8 = MotionEventCompat.getX(paramMotionEvent, i5);
        float f9 = Math.abs(f8 - this.mLastMotionX);
        float f10 = Math.abs(MotionEventCompat.getY(paramMotionEvent, i5) - this.mLastMotionY);
      ...
      if (f3 < f4)
      {
        ...
        {
          float f7 = -f3;
          bool = this.mLeftEdge.onPull(f7 / i2);
        }
        f3 = f4;
      }
      while (true)
      {
        ...
        {
          float f6 = f3 - f5;
          bool = this.mRightEdge.onPull(f6 / i2);
        }
        f3 = f5;
      }
      if (!this.mIsBeingDragged)
      ...
      int i1 = getScrollX();
      setCurrentItemInternal(determineTargetPage(i1 / n, i1 % n / n, m, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.mActivePointerId)) - this.mInitialMotionX)), true, true, m);
      this.mActivePointerId = -1;
      endDrag();
