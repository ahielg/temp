...
public class TimeUtils
{
  ...
  private static int formatDurationLocked(long paramLong, int paramInt)
  {
    ...
    label305: label311: label317: label323: for (int i19 = 3; ; i19 = 0)
    {
    ...
    label515: label521: label527: label533: label539: label545: label551: for (int i12 = 3; ; i12 = 0)
    {
