...
/*            int subindex;*/
    ...
    public static String getParashaAsString(int parashaNum) {
        ...
        if (parashaNum > 52) {
            ...
            parasha = "פרשות " + parasha1.substring(0, parasha1.indexOf('-'));
        }
        return parasha;
    }
    ...
    public static int getNextParashaNumOnShabat(Calendar c) {
        while (c.get(Calendar.DAY_OF_WEEK) != Calendar.SATURDAY) {
            c.add(Calendar.DAY_OF_MONTH, 1);
        }
        RegularHebrewDate h1 = new RegularHebrewDate(c.getTime());
